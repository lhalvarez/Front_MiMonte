      ...
      >
        ...
        <Row>
          <Col
            ...
            className={`${styles.main_Panel__Content} ${styles.texto}`}
          >
            Todo Nacional Monte de Piedad a tu alcance, con Mi Monte podrás
            tener tu tarjeta siempre contigo, conocer tu nivel de cliente,
            estado de cuenta y fechas próximas de pago.
          </Col>
        </Row>
        <Row>
          <Col>
